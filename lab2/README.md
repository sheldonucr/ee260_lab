...
* Your Waveform View result with transient analysis result (SAE, HSPICE) to show `OUT'=AIN*BIN`, you need one capacitance load at the output to remove noise. Expected result can be seen in Fig 66.
